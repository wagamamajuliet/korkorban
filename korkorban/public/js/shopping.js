        ...
        //     if(shoppingCart.countCart() > 101) {
        //         $("#cart-show").css('font-size','10px');
        //         $("#cart-show2").css('font-size','10px');
        //     } else {
        //         $("#cart-show").css('font-size','');
        //         $("#cart-show2").css('font-size','');               
        //     }
        // })
        ...
        var shoppingCart = (function(){
            ...
            var saveCart = function() {
                localStorage.setItem("kor", JSON.stringify(cart));
            };

            var loadCart = function() {
                cart = JSON.parse(localStorage.getItem("kor"));
            };
    ...
    function displayCart() {
        ...
        $("#cart-show").html(shoppingCart.countCart());
        $("#cart-show2").html(shoppingCart.countCart());
